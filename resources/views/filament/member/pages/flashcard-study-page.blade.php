            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-sm text-gray-500 dark:text-gray-400">
                            {{ $currentCardIndex + 1 }} / {{ count($flashcards) }}
                        </span>
                        <button
                ...
                <div class="relative">
                        ...
                        <div class="flex items-center justify-center h-full">
                            ...
                            <div class="text-center">
                                ...
                                <div class="text-xl font-medium text-gray-900 dark:text-white">
                                    {!! nl2br(e($currentCard->back_content)) !!}
                                </div>
                            </div>
                            @else
                            <!-- Question Side -->
                            <div class="text-center">
                                ...
                                <div class="text-xl font-medium text-gray-900 dark:text-white">
                                    {!! nl2br(e($currentCard->front_content)) !!}
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <button
                            wire:click="nextCard"
                            @if($currentCardIndex>= count($flashcards) - 1) disabled @endif
                    ...
                    <div class="mt-6">
                        <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                            <div
                                ...
                                :style="'width: ' + (count($flashcards) > 0 ? (($currentCardIndex + 1) / count($flashcards)) * 100 : 0) + '%'"></div>
                        </div>
                    </div>
                </div>
                @else
                <div class="text-center py-12">
                    ...
                    <div class="mt-4">
                        <a
                            href="{{ route('filament.admin.resources.flashcard-decks.edit', $deck) }}"
