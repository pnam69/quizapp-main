    ...
    private function generateMockAnswers(Assessment $assessment): array
    {
        ...
        foreach ($questions as $question) {
            ...
            if ($options->isNotEmpty()) {
                ...
                // For this attempt, we need to determine if the student got it right
                // This will be handled by the AssessmentAttempt creation logic
                // For now, we'll randomly select but bias toward correct answers
