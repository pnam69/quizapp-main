    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                ->label('Classroom')->sortable(),
                Tables\Columns\TextColumn::make('section.name')->label('Section')->sortable(),
                Tables\Columns\TextColumn::make('certification.name')->label('Certification')->sortable(),
