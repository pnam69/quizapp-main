    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                //     ->password()
                //     ->revealable()
                //     ->dehydrated(true) // always include when filled
                //     ->dehydrateStateUsing(fn($state) => filled($state) ? Hash::make($state) : null)
                //     ->afterStateHydrated(fn($component, $state) => $component->state('')) // clear on load
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TagsColumn::make('sections.name')->label('Faculties'),
                Tables\Columns\TagsColumn::make('certifications.name')->label('Departments'),
            ])
            ->filters([
