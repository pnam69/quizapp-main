        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('sections')
                    ->label('Sections')
                    ->relationship('sections', 'name')  // plural because belongsToMany
                    ->preload()
                    ->multiple()                        // REQUIRED for belongsToMany
                    ->searchable()
                    ->nullable(),

                Forms\Components\Select::make('certifications')
                    ->label('Certifications')
                    ->relationship('certifications', 'name')  // plural because belongsToMany
                    ->preload()
                    ->multiple()                             // REQUIRED for belongsToMany
                    ->searchable()
                    ->nullable(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TagsColumn::make('certifications.name')
                    ->label('Certifications'),
