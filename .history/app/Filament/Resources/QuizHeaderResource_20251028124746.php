    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('quiz_size')->required()->numeric(),
                Forms\Components\Textarea::make('questions_taken')->maxLength(65535)->columnSpanFull(),
                Forms\Components\TextInput::make('score')->required()->numeric()->default(0),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('score')->numeric()->suffix('%')->sortable(),
                Tables\Columns\TextColumn::make('quiz_size')->numeric()->sortable()->toggleable(isToggledHiddenByDefault: true),
