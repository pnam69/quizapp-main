...
class CreateMyQuiz extends Page implements Forms\Contracts\HasForms
{
    ...
    public static ?string $navigationIcon = 'heroicon-o-plus-circle';
    protected static string $view = 'filament.member.pages.create-my-quiz';
    public static ?string $navigationIcon = 'heroicon-o-plus-circle';
    public static ?string $title = 'Create My Quiz';
    public static ?string $navigationLabel = 'Create Quiz';
    public static ?string $slug = 'create-my-quiz';
