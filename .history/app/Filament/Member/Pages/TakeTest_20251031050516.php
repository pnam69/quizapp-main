...
class TakeTest extends Page
{
    ...
    public function selectQuiz($quizId)
    {
        ...
        // old design: questions are taken from questions_taken array
        $questionIds = $this->selectedQuiz->questions_taken ?? [];
        $this->questions = \App\Models\Question::whereIn('id', $questionIds)->get();

        $this->answers = [];
        dd($this->selectedQuiz->questions_taken)
    }
