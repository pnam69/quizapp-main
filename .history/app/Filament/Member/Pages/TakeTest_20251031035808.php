...
class TakeTest extends Page
{
    ...
    public function selectQuiz($quizId)
    {
        ...
        // Pull related quiz questions and their actual question + answers
        $this->questions = $this->selectedQuiz
            ->questions()
        ...
        // dd($this->questions); // you can enable this temporarily to check data
    }
