...
class AssignedTests extends Page
{
    ...
    // Hide from navigation - functionality covered by TakeTest page
    ...
    public function mount(): void
    {
        ...
        $this->assignedQuizzes = QuizHeader::with(['section', 'certification'])
            ->where(function ($query) use ($sectionIds, $certificationIds) {
