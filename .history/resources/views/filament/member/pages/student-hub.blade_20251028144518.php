            ...
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                ...
                <div class="flex flex-wrap items-center gap-3 mt-3 sm:mt-0">
                    ...
                    <a href="{{ asset('storage/' . $file) }}" target="_blank"
                        class="px-3 py-1 rounded-full border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-700 text-sm font-medium text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-600 transition">
                        📄 View File
                    </a>
                    @endforeach
                    @endif
                    ...
                    <a href="{{ $hub->link_url }}" target="_blank"
                        class="px-3 py-1 rounded-full border border-gray-300 dark:border-gray-700 bg-blue-100 dark:bg-blue-800 text-sm font-medium text-blue-800 dark:text-blue-100 hover:bg-blue-200 dark:hover:bg-blue-700 transition">
                        🔗 Open Link
                    </a>
                    @endif
