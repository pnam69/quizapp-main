<x-filament-panels::page>
    ...
    <div class="relative min-h-screen">
        {{-- Quick tips sidebar --}}
        @if ($selectedAssessment && empty($results))
        ...
        <div class="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl shadow-lg p-8 text-white mb-6">
                ...
                <div class="flex gap-4 text-sm mt-4">
                    <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                        📝 {{ count($assessments) }} Test{{ count($assessments) !== 1 ? 's' : '' }} Available
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2">{{ $assessment->description }}</p>
                                @endif
                        ...
                        <div class="mt-6">
                            <x-filament::button
                                color="primary"
                                wire:click="selectTest({{ $assessment->id }})"
                                class="w-full"
                                size="lg"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-blue-100 text-lg font-semibold">
                                Your Score: <span class="text-green-300 text-xl font-bold">{{ $score }}%</span>
                            </p>
                            @endif
                        </div>
                        <x-filament::button
                ...
                <div class="p-8">
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl p-8 mb-8 border-2 border-green-200 dark:border-green-800">
                        <div class="text-center">
                            <div class="text-6xl font-bold text-green-600 dark:text-green-400 mb-2">{{ $score }}%</div>
                            <div class="text-xl text-gray-600 dark:text-gray-400">Your Test Score</div>
                        </div>
                    </div>
                    @endif
                    ...
                    <form wire:submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="p-6 bg-white dark:bg-gray-800">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <label class="flex items-start p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 shadow-sm
                                              ...
                                              {{ $isIncorrect ? 'border-red-500 bg-red-50 dark:bg-red-900/30' : '' }}
                                              {{ !$isCorrect && !$isIncorrect && $isSelected ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : '' }}
                                              {{ !$isCorrect && !$isIncorrect && !$isSelected ? 'border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md hover:scale-[1.01]' : '' }}">
                                        <input type="radio"
                                        ...
                                        <div class="flex items-center gap-4 w-full">
                                            <div class="shrink-0 w-10 h-10 rounded-full border-2 flex items-center justify-center font-bold text-sm transition-all duration-200
                                                    ...
                                                    {{ !$isCorrect && !$isIncorrect && $isSelected ? 'border-blue-500 bg-blue-500 text-white' : '' }}
                                                    {{ !$isCorrect && !$isIncorrect && !$isSelected ? 'border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400' : '' }}">
                                                @if ($isCorrect)
                                            ...
                                            <span class="flex-1 text-base
                                                     ...
                                                     {{ !$isCorrect && !$isIncorrect && $isSelected ? 'text-gray-900 dark:text-gray-100 font-medium' : '' }}
                                                     {{ !$isCorrect && !$isIncorrect && !$isSelected ? 'text-gray-700 dark:text-gray-300' : '' }}">
                                                {{ $option->option_text }}
                                            </span>
                                        </div>
                                    </label>
                        ...
                        <div class="flex justify-between items-center pt-6 border-t-2 border-gray-200 dark:border-gray-700">
                            ...
                            <x-filament::button
                                color="primary"
                                wire:click="selectTest({{ $selectedAssessment->id }})"
