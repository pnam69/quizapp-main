                                ...
                                <label class="flex items-start p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 group
                                    ...
                                    <div class="flex items-center gap-4 w-full">
                                        <div class="shrink-0 w-10 h-10 rounded-full border-2 flex items-center justify-center font-bold text-sm
                                            {{ $isCorrectOption ? 'border-green-500 bg-green-500 text-white' : ($isChosenOption ? 'border-red-500 bg-red-500 text-white' : 'border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400') }}">
                                        ...
                                        <input type="radio"
                                            ...
                                            class="sr-only"
                                            {{ $isAnswered ? 'disabled' : '' }}>
                                        <span class="flex-1 text-base {{ ($isCorrectOption || $isChosenOption) ? 'font-medium' : '' }} text-gray-700 dark:text-gray-300">
                                            {{ $option->answer }}
                                        </span>
