        ...
        <div class="space-y-6">
            <div class="p-6 rounded-xl shadow-md border border-gray-200 bg-white dark:bg-gray-900">
                ...
                @else
                    ...
                    @endphp
                    <div class="mb-2">
                        <span class="inline-block px-3 py-1 rounded-full bg-green-100 dark:bg-green-700 text-green-800 dark:text-green-200 font-semibold">
            ...
            <form wire:submit.prevent="submit" class="space-y-6">
                @foreach ($questions as $index => $question)
                    ...
                    <div class="p-5 rounded-lg border border-gray-200 bg-white dark:bg-gray-800 shadow-sm">
                        ...
                        @if ($isAnswered)
                            <div class="mt-2">
                                @if ($chosen == $correct)
                                    <span class="text-green-600 dark:text-green-400 font-semibold">Correct!</span>
                                @else
                                    <span class="text-red-600 dark:text-red-400 font-semibold">Incorrect. Correct answer highlighted.</span>
                                @endif
                            </div>
                        @endif
                    </div>
                ...
                <div class="flex flex-col sm:flex-row justify-between pt-4 gap-2">
