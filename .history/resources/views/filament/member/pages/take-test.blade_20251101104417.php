<x-filament-panels::page>
    ...
    <div class="relative min-h-screen">
        ...
        <div class="fixed top-24 left-6 z-10 hidden xl:block max-w-xs">
            <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl shadow-lg p-4 border border-gray-200/50 dark:border-gray-700/50">
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <span class="text-sm font-medium text-gray-900 dark:text-gray-100">Quick Tips</span>
                </div>
        ...
        <div class="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-8 xl:ml-80">
            @if (!$selectedTest)
            {{-- Test List View --}}
