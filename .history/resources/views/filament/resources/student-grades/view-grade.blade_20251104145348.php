    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm">
        ...
        <div class="p-5 max-h-[500px] overflow-y-auto">
            <div class="space-y-3">
                ...
                <div class="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border {{ $answer->is_correct ? 'border-green-200 dark:border-green-900/50' : 'border-red-200 dark:border-red-900/50' }}">
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0">
                            <div class="w-8 h-8 rounded-lg {{ $answer->is_correct ? 'bg-green-100 dark:bg-green-900/50' : 'bg-red-100 dark:bg-red-900/50' }} flex items-center justify-center">
                            ...
                            <div class="flex items-start justify-between gap-3 mb-2">
                                ...
                                <div class="flex-shrink-0 flex items-center gap-2">
                                    ...
                                    <span class="text-sm font-bold {{ $answer->is_correct ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                                        {{ intval($answer->points_earned ?? 0) }} pts
                                    </span>
                                </div>
                            </div>
