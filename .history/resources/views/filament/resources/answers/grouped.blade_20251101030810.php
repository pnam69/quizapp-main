    ...
    <div class="mt-6 flex items-center justify-center space-x-2">
        @for ($i = 1; $i <= $totalPages; $i++)
            ...
            class="px-3 py-1 rounded border dark:border-gray-600 
                       {{ $page == $i ? 'bg-blue-600 text-white dark:bg-blue-500 dark:text-gray-100 font-semibold' : 'bg-white text-gray-700 dark:bg-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600' }}">
            {{ $i }}
            </button>
            @endfor
    </div>
