...
<div class="hidden">Current: <?php echo e($currentLocale); ?> | App: <?php echo e(App::getLocale()); ?></div>
...
<div x-data="{ open: false }" class="relative">
    ...
    <button
        ...
        <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-bold bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 rounded">
            <?php echo e($languages[$currentLocale]['flag']); ?>

        </span>
        <span><?php echo e($languages[$currentLocale]['name']); ?></span>
    ...
    <div
        ...
        <div class="py-1">
            ...
            <form action="<?php echo e(route('language.switch')); ?>" method="POST" class="inline w-full">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="locale" value="<?php echo e($code); ?>">
                <button
                    type="submit"
                    class="w-full flex items-center gap-3 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-150 <?php echo e($currentLocale === $code ? 'bg-gray-50 dark:bg-gray-900 font-semibold' : ''); ?>">
                    <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-bold bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300 rounded">
...
</div><?php /**PATH D:\Android\quizapp1\quizapp-main\quizapp-main\resources\views/livewire/language-switcher.blade.php ENDPATH**/ ?>