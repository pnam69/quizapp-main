...
<?php $component->withAttributes([]); ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($completedQuizzes->isEmpty()): ?>
    <p>You haven’t completed any quizzes yet.</p>
    <?php else: ?>
    <ul class="list-disc pl-6">
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $completedQuizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
            <?php echo e($quiz->title ?? 'Untitled Quiz'); ?> —
            Score: <?php echo e($quiz->score ?? 'N/A'); ?>%
        </li>
