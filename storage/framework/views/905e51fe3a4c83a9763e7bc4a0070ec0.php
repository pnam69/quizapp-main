...
<?php $component->withAttributes([]); ?>
    <div class="max-w-7xl mx-auto space-y-6">
                ...
                <div>
                    ...
                    <div class="flex gap-4 text-sm mt-4">
                        <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                            📋 <?php echo e(count($assignedQuizzes)); ?> Test<?php echo e(count($assignedQuizzes) !== 1 ? 's' : ''); ?> Assigned
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                            ⏳ Pending Completion
                        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $assignedQuizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="flex flex-wrap gap-3 mt-3">
                                    ...
                                    <div class="inline-flex items-center gap-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full text-sm font-medium">
                                        ...
                                        Section: <?php echo e($quiz->section->name); ?>

                                    </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($quiz->certification): ?>
                                    <div class="inline-flex items-center gap-1.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-3 py-1 rounded-full text-sm font-medium">
                                        ...
                                        Certification: <?php echo e($quiz->certification->name); ?>
                                    ...
                                    <div class="inline-flex items-center gap-1.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-3 py-1 rounded-full text-sm font-medium">
                                        ...
                                        Assigned: <?php echo e($quiz->created_at->format('M d, Y')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'primary','href' => '#','size' => 'lg','icon' => 'heroicon-o-play']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','href' => '#','size' => 'lg','icon' => 'heroicon-o-play']); ?>
                            Take Quiz
