...
<?php $component->withAttributes([]); ?>
    ...
    <div class="relative min-h-screen">
        ...
        <!--[if BLOCK]><![endif]--><?php if($selectedAssessment && empty($results)): ?>
        ...
        <div class="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-8">
            <!--[if BLOCK]><![endif]--><?php if(!$selectedAssessment): ?>
            ...
            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl shadow-lg p-8 text-white mb-6">
                ...
                <div class="flex gap-4 text-sm mt-4">
                    <div class="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">
                        📝 <?php echo e(count($assessments)); ?> Test<?php echo e(count($assessments) !== 1 ? 's' : ''); ?> Available
                    </div>
                </div>
            </div>

            <div class="grid md:grid-cols-2 gap-6">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $assessments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assessment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <h3 class="text-xl font-bold text-gray-900 dark:text-gray-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                                    <?php echo e($assessment->title ?? 'Untitled Test'); ?>

                                </h3>
                                <!--[if BLOCK]><![endif]--><?php if($assessment->description): ?>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-2"><?php echo e($assessment->description); ?></p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                <div class="flex items-center gap-2 mt-3 flex-wrap">
                                    <div class="inline-flex items-center gap-1.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full text-sm font-medium">
                                        ...
                                        <?php echo e($assessment->total_questions); ?> Questions
                                    </div>
                                    <!--[if BLOCK]><![endif]--><?php if($assessment->time_limit): ?>
                                    <div class="inline-flex items-center gap-1.5 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 px-3 py-1 rounded-full text-sm font-medium">
                                        ...
                                        <?php echo e($assessment->time_limit); ?> min
                                    </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($assessment->total_points): ?>
                                    <div class="inline-flex items-center gap-1.5 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 px-3 py-1 rounded-full text-sm font-medium">
                                        ...
                                        <?php echo e($assessment->total_points); ?> points
                                    </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'primary','wire:click' => 'selectTest('.e($assessment->id).')','class' => 'w-full','size' => 'lg','icon' => 'heroicon-o-play']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','wire:click' => 'selectTest('.e($assessment->id).')','class' => 'w-full','size' => 'lg','icon' => 'heroicon-o-play']); ?>
                                Start Test
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <h2 class="text-2xl font-bold mb-1">
                                <?php echo e($selectedAssessment->title ?? 'Test'); ?>
                        ...
                        <div class="border-2 rounded-xl overflow-hidden border-gray-200 dark:border-gray-700">
                            <div class="p-6 bg-white dark:bg-gray-800">
                                ...
                                <div class="space-y-3">
                                    ...
                                    $isCorrect = isset($results[$question->id]) && $results[$question->id]['correctAnswer'] == $option->id;
                                    $isIncorrect = isset($results[$question->id]) && $results[$question->id]['userAnswer'] == $option->id && !$results[$question->id]['isCorrect'];
                                    ?>
                                    <label class="flex items-start p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 shadow-sm
                                              <?php echo e($isCorrect ? 'border-green-500 bg-green-50 dark:bg-green-900/30' : ''); ?>

                                              <?php echo e($isIncorrect ? 'border-red-500 bg-red-50 dark:bg-red-900/30' : ''); ?>

                                              <?php echo e(!$isCorrect && !$isIncorrect && $isSelected ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/30' : ''); ?>

                                              <?php echo e(!$isCorrect && !$isIncorrect && !$isSelected ? 'border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md hover:scale-[1.01]' : ''); ?>">
                                        <input type="radio"
                                            wire:model.live="answers.<?php echo e($question->id); ?>"
                                            value="<?php echo e($option->id); ?>"
                                            class="sr-only peer"
                                            <?php echo e(isset($results[$question->id]) ? 'disabled' : ''); ?>>

                                        <div class="flex items-center gap-4 w-full">
                                            <div class="shrink-0 w-10 h-10 rounded-full border-2 flex items-center justify-center font-bold text-sm transition-all duration-200
                                                    <?php echo e($isCorrect ? 'border-green-500 bg-green-500 text-white' : ''); ?>

                                                    <?php echo e($isIncorrect ? 'border-red-500 bg-red-500 text-white' : ''); ?>

                                                    <?php echo e(!$isCorrect && !$isIncorrect && $isSelected ? 'border-blue-500 bg-blue-500 text-white' : ''); ?>

                                                    <?php echo e(!$isCorrect && !$isIncorrect && !$isSelected ? 'border-gray-300 dark:border-gray-600 text-gray-500 dark:text-gray-400' : ''); ?>">
                                            ...
                                            <span class="flex-1 text-base
                                                     <?php echo e($isCorrect ? 'text-green-700 dark:text-green-300 font-medium' : ''); ?>

                                                     <?php echo e($isIncorrect ? 'text-red-700 dark:text-red-300' : ''); ?>

                                                     <?php echo e(!$isCorrect && !$isIncorrect && $isSelected ? 'text-gray-900 dark:text-gray-100 font-medium' : ''); ?>

                                                     <?php echo e(!$isCorrect && !$isIncorrect && !$isSelected ? 'text-gray-700 dark:text-gray-300' : ''); ?>">
...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['color' => 'primary','wire:click' => 'selectTest('.e($selectedAssessment->id).')','icon' => 'heroicon-o-arrow-path','size' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('filament::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','wire:click' => 'selectTest('.e($selectedAssessment->id).')','icon' => 'heroicon-o-arrow-path','size' => 'lg']); ?>
                                Retake Test
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6330f08526bbb3ce2a0da37da512a11f)): ?>
