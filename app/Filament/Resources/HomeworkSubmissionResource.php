        ...
        return $form
            ->schema([
                ...
                Forms\Components\Textarea::make('submission_text')
                    ...
                    ->rows(5)
                    ->disabled(),
                Forms\Components\Repeater::make('submitted_files')
                ...
                Tables\Columns\TextColumn::make('submitted_files')
                    ...
                    ->formatStateUsing(function ($state) {
                        ...
                        if (is_string($state)) {
                            ...
                            return $files && is_array($files) ? count($files) . ' file(s)' : 'No files';
                        }
                        return is_array($state) ? count($state) . ' file(s)' : 'No files';
                    })
                    ->badge(),
