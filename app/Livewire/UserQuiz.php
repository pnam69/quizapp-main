...
class UserQuiz extends Component implements HasForms
{
    ...
    public function showResults()
    {
        ...
        if ($user) {
            ...
            // Determine difficulty level from the quiz
            $difficulty = 'medium'; // Default
            if ($this->currentquizHeader->test && $this->currentquizHeader->test->difficulty_level) {
                $difficulty = $this->currentquizHeader->test->difficulty_level;
            }

            $gamificationService->awardQuizCompletionXp(
                $user,
                $correct,
                $total,
                $difficulty
